...
//	@Test
//	void testAddNewUser() throws SQLException, ParseException {
//		UserInfo user = new UserInfo("cacy", "c", "c", "c", "2002-10-18");
...
//		
//		boolean expResult = true;
//		boolean actual = userAction.updateUser(user);
//		assertEquals(expResult, actual);
//	}

//	@Test
//	void testDeleteNewUser() throws SQLException, ParseException {
//		int id = 2;
//		UserActionDAO userAction = new UserActionDAOImpl();
//		
//		boolean expResult = true;
